...
public class bufferreaderGustu {

    private static void createDataToFile(String fileName, String nim, String namaMhs, int umur, int nilaiUts, int nilaiUas){
    ...
    private static void bacaFile(String fileName, String[] nimArray, String[] namaMhsArray, int[] umurArray, int[] nilaiUtsArray, int[] nilaiUasArray) throws IOException{
        String baris;
        int index = 0;
            ...
            switch (pilih) {
                ...
                case 2 :
                    ...
                    try {
                        ...
                        bacaFile("data_mahasiswa2.txt", nimArray, namaMhsArray, umurArray, nilaiUtsArray, nilaiUasArray);
